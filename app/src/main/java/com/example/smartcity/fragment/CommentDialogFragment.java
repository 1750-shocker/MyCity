...
public class CommentDialogFragment extends DialogFragment implements View.OnClickListener{
    ...
    private ImageView imageBtnPhoto;
    private ImageView imageBtnAt;
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.image_btn_at) {
            Toast.makeText(getActivity(), "Pick someone to @", Toast.LENGTH_SHORT).show();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        imageBtnPhoto = (ImageView) mDialog.findViewById(R.id.image_btn_photo);
        imageBtnAt = (ImageView) mDialog.findViewById(R.id.image_btn_at);
        ...
        imageBtnPhoto.setOnClickListener(this);
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable editable) {
            if (temp.length() > 0) {
                ...
                imageBtnCommentSend.setColorFilter(ContextCompat.getColor(getActivity(), R.color.purple_500));
            } else {
                imageBtnCommentSend.setEnabled(false);
                imageBtnCommentSend.setColorFilter(ContextCompat.getColor(getActivity(), R.color.iconCover));
            }
