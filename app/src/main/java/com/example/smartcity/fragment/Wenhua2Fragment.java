...
public class Wenhua2Fragment extends Fragment {
    private static final String TAG = "WenhuaFragment";
    private RecyclerView recycler;
    private List<RowsDTO> rows;
    private Banner banner;

    public static Wenhua2Fragment newInstance() {
        Wenhua2Fragment fragment = new Wenhua2Fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_jingji2, container, false);
